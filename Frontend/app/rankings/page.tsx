    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-gray-600 mb-6">
          This page displays the coding profile rankings jjjjof our students based on their performance on various coding platforms.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <h3 className="text-orange-800 font-semibold">Expert+ Rated</h3>
